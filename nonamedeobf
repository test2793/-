    ...
    local etc = {
        ...
        MapPoints = {
            ["рџџ©Green Houseрџџ©"] = CFrame.new(-548.305054, -2.45424771, 79.3213348),
            ["рџ©·Pink Houseрџ©·"] = CFrame.new(-475.493835, -2.70774508, -159.395279),
            ["рџ¦‡Witch Houseрџ¦‡"] = CFrame.new(270.225922, -2.48055029, 458.186493),
            ["рџџ¦Blue Houseрџџ¦"] = CFrame.new(501.939911, 88.2323608, -349.129211),
            ["рџЂ„China Houseрџ’®"] = CFrame.new(545.441833, 128.004593, -99.4881439)
        },
        LastBlob = nil,
        LastTrainSeat = nil
    }
    ...
    Toggles["LoopTpHouse"] = DefTab:AddDropdown({
        ...
        Default = "рџџ©Green Houseрџџ©",
        Options = {"рџџ©Green Houseрџџ©", "рџ©·Pink Houseрџ©·","рџ¦‡Witch Houseрџ¦‡","рџџ¦Blue Houseрџџ¦","рџЂ„China Houseрџ’®"},
        Save = true,
        Flag = "LoopTpHouse",
        Callback = function(Value)
    ...
    local function SetupAntiBurn(char)
        ...
        if not Barrier then warn("[DEBUG] РљР°РєРѕРіРѕ С…СѓСЏ??") return end 
...
TarTab:AddButton({
    ...
    TarTab:AddParagraph("NOTE", [[<font color="#FF00FF"><b>[WD]</b></font> РџРѕРјРѕР¶РµС‚ РѕС‚ Р±Р»РёР·Р·РѕРІ Сѓ РєРѕС‚РѕСЂС‹С… Р°РЅС‚РёРєРёРє СЃРЅРѕСЃРёС‚СЃСЏ С…РѕС‚СЊ С‡РµРј 
    <font color="#00FF00"><b>[CLICK]</b></font> СЃР°РјС‹Р№ РѕР±С‹С‡РЅС‹Р№ РєР»РёРєРµСЂ РєРѕС‚РѕСЂС‹Р№ РїСЂРѕСЃС‚Рѕ СЃС‚Р°РІРёС‚ РЅРµС‚РІРѕСЂРє РѕРІРЅРµСЂР° 
    <font color="#64FF64"><b>[BYPASS]</b></font> Р‘СѓРґРµС‚ РїС‹С‚Р°С‚СЊСЃСЏ СЃР»РѕРјР°С‚СЊ Р°РЅС‚РёРєРёРє С‡С‚Рѕ Р±С‹ РѕРЅ Р·Р°Р±Р°РіР°Р»СЃСЏ РІ РІРѕР·РґСѓС…Рµ, РјРѕР¶РµС‚ РїРѕРґРЅСЏС‚СЊ РїРёРЅРі рџ›њ
    <font color="#FF64FF"><b>[BLACKHOLE]</b></font> Р‘СѓРґРµС‚ РїС‹С‚Р°С‚СЊСЃСЏ СЃРЅРµСЃС‚Рё Р°РЅС‚РёРєРёРє С‡РµСЂРЅРѕР№ РґС‹СЂРѕР№ РѕС‚ СЃРїР°РјР° РїСЂРµРґРјРµС‚РѕРІ, РїРѕР»РµР·РЅРѕ РµСЃР»Рё Р°РЅС‚РёРєРёРє РёР· РґРѕРјР°]])
    TarTab:AddToggle({
    ...
    TarTab:AddButton({
        Name = "Destroy Gucci[JUMP/SIT]рџ“›",
        Callback = function()
            local blobs = {}
    ...
    Toggles["Redeemed"] = MiscTab:AddLabel("рџ›њрџ”Ѕ Redeemed packets:"..tostring(int.RedeemPackets))
    Toggles["Sent"] = MiscTab:AddLabel("рџ›њрџ”ј Sent packets:"..tostring(int.SentPackets))
    ...
    MiscTab:AddToggle({
        ...
        Callback = function(Value)
            ...
            while bool.LagPacket and task.wait(0.1) do
                ...
                int.SentPackets += 1
                Toggles["Sent"]:Set("рџ›њрџ”ј Sent packets:"..tostring(int.SentPackets))
            end
        end    
    })
    MiscTab:AddToggle({
    ...
    MiscTab:AddSection({ Name = "<b>Р РђР—РќРћРЎ Р”РћРњРђРђРђ!!</b>"})
    MiscTab:AddDropdown({
    ...
    MiscTab:AddButton({
        Name = "Р Р°Р·РЅРµСЃС‚Рё РІСЃРµ РґРѕРјР°",
        Callback = function()
            local clone = SpawnToy("YouDecoy")
    ...
    task.delay(2,function()
        ...
        while task.wait(0.025) do
            if tick() - StartTick >= 0.1 then
                -- Р±Р»Р° Р±Р»Р° Р±Р»Р° Р°РЅС‚РёР»Р°Рі
                if CountOfLines >= 40 then
                    ...
                    if LagPlr and OrionLib and bool.AutoAntiLag then 
                        OrionLib:MakeNotification({
                            ...
                            Content = "<font color=\"rgb(100, 0, 100)\"><b>[рџ’ўLAG] </b></font>: "..LagPlr.Name.."(@"..LagPlr.DisplayName..")",
                            Image = "angry",
                            Time = 5
                        })
    ...
    RS.GrabEvents.ExtendGrabLine.OnClientEvent:Connect(function(arg1,data)
        if typeof(data) == "string" and not WasLagged then 
            ...
            if StringLen > 300 then 
                int.RedeemPackets += 1
                Toggles["Redeemed"]:Set("рџ›њрџ”Ѕ Redeemed packets:"..tostring(int.RedeemPackets))
    ...
    game.Players.PlayerAdded:Connect(function(plr1)
        ...
        if plr1.Name == selectedPlrName then 
            OrionLib:MakeNotification({
                ...
                Content = "<font color=\"rgb(0, 255, 0)\"><b>[рџљЄJOIN] </b></font>"..plr1.Name.." ("..plr1.DisplayName..")",
                Image = "user-plus",
                Time = 5
            })
    ...
    game.Players.PlayerRemoving:Connect(function(plr1)
        ...
        if CFP(workspace,"BlackHoleKick") then 
            ...
            OrionLib:MakeNotification({
                ...
                Content = "<font color=\"rgb(255, 93, 0)\"><b>[рџ¦µKICK] </b></font>"..plr1.Name.." ("..plr1.DisplayName..")",
                Image = "user-lock",
                Time = 5
            })
        else 
            ...
            Content = "<font color=\"rgb(255, 217, 0)\"><b>[рџ¤ќLEFT] </b></font>"..plr1.Name.." ("..plr1.DisplayName..")",
            Image = "user-minus",
            Time = 5
        })
        end
